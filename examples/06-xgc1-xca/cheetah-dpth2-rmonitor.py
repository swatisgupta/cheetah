...
class XGC1XCA(Campaign):
    ...
    supported_machines = ['local', 'summit', 'deepthought2_cpu']
    ...
    sweep1_parameters = [
            ...
            p.ParamKeyValue       ('xgc1', 'total_steps', 'XGC1_exec/input', 'sml_mstep', [50]),
            ...
            p.ParamKeyValue       ('xgca', 'total_steps', 'XGCa_exec/input', 'sml_mstep', [50]),
    ...
    #xgc1_node.cpu[8] = "rmonitor:0"
    #xgc1_node.cpu[9] = "restart1:0"
    #for i in range(8):
    #    xgca_node.cpu[i] = "xgca:{}".format(i)
    #seperate_node_layout1 = [xgc1_node, xgca_node]

    xgc1_node1 = DTH2CPUNode()
    xgca_node1 = DTH2CPUNode()
    for i in range(16):
        xgc1_node1.cpu[i] = "xgc1:{}".format(i)
    xgc1_node1.cpu[18] = "restart1:0"
    xgc1_node1.cpu[19] = "rmonitor:0"
    for i in range(16):
        xgca_node1.cpu[i] = "xgca:{}".format(i)
    seperate_node_layout2 = [xgc1_node1, xgca_node1]
    ...
    sweep2 = p.Sweep (parameters = sweep1_parameters, node_layout={'deepthought2_cpu':seperate_node_layout2}, rc_dependency={'xgca':'xgc1', 'restart1':'xgca'})
    #sweep3 = p.Sweep (parameters = sweep1_parameters, node_layout={'local': [{'xgca': 8}, {'xgc1':8}, {'rmonitor':1}, {'restart1':1}]}, rc_dependency={'xgca':'xgc1','restart1':'xgca'})
    ...
    sweepGroup1 = p.SweepGroup ("sg-1", # A unique name for the SweepGroup
                                ...
                                nodes=4,  # No. of nodes for the batch job.
